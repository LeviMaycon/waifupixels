        ...
        <Sheet>
            <SheetTrigger asChild>
                <Button
                    size="icon"
                    variant="ghost"
                    className="fixed top-3 left-3 z-50 h-9 w-9 rounded-xl bg-black/60 backdrop-blur-sm border border-white/10 text-white hover:bg-white/10 hover:text-white transition-all duration-200 shadow-lg"
                >
                    <Menu size={18} />
                </Button>
            </SheetTrigger>
            ...
            <SheetContent
                side="left"
                hideClose
                className="w-72 p-0 border-r border-white/10 bg-[#0d0d12] text-white shadow-2xl"
            >
                <div className="flex flex-col h-full">
                    <SheetHeader className="flex flex-row justify-between items-center px-5 py-4 border-b border-white/10">
                        ...
                        <SheetClose asChild>
                            <Button
                                className="h-7 w-7 p-0 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white/60 hover:text-white transition-all duration-150"
                                variant="ghost"
                            >
                                <X size={14} />
                            </Button>
